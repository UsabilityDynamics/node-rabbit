...
Object.defineProperties(module.exports = RabbitClient, {
        ...
        value: function sessionStore(connect) {
            ...
            function rabbitStore(options) {
                ...
                self.client.on("error", function() {
                    _$jscoverage_done("lib/rabbit-client.js", 479);
                    self.emit("disconnect");
                });
                _$jscoverage_done("lib/rabbit-client.js", 482);
                self.client.on("connect", function() {
                    _$jscoverage_done("lib/rabbit-client.js", 483);
                    self.emit("connect");
                });
            }
            _$jscoverage_done("lib/rabbit-client.js", 489);
            rabbitStore.prototype.__proto__ = Store.prototype;
            _$jscoverage_done("lib/rabbit-client.js", 495);
            ...
            _$jscoverage_done("lib/rabbit-client.js", 517);
            return rabbitStore;
        },
        enumerable: true,
        configurable: true,
    ...
    startService: {
        get: function startService() {
            _$jscoverage_done("lib/rabbit-client.js", 532);
